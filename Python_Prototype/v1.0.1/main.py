try:
    ...
    def expense(): # expense function allows user to record bills and expenses that have been incured on their account. 
        ...
        while True:
            ...
            if expense_type == "other":
                ...
                print(f"{t.red}{t.bold}Process Failed: Invalid input!{t.end}")
    ...
    def income():  
        ...
        try:
            ...
            print(f"{t.red}{t.bold}ValueError: Please Enter a Valid Number!{t.end}")
    ...
    def change_currency():
        ...
        if user_input in currencies:
            ...
            # DO NOT use os.path.dirname(__file__), USE os.getcwd() instead, idk why but the latter does not work
            directory = os.getcwd()
            matching_files = [file for file in os.listdir(directory) if '01' in file]



            # for testing purposes to see IF IT CAN FUCKING SEE THE FILES IN ITS OWN DIRECTORY!!
            """print(matching_files)"""
            
            # Check if there are any matching files
            # if this if statement is triggered then there is a big oopsie
            ...
            print(f"{t.red}{t.bold}Invalid Currency!{t.end}")
    ...
    def print_to_pdf(month): # creates pdf files of a specified month
        try:
            ...
            print(f"{t.red}{t.bold}Files for {month} Was not Found!{t.end}")
    ...
    print(f"{t.red}{t.bold}Warning Keyboard Interrupt May Corrupt Files{t.end}")    
    sys.exit(0)