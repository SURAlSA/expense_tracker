...
def options():
    ...
    user_input = input(f"1. Reset App Data:\n"
                       ...
                       f"3. View full transaction history:\n"
                       )
...
def main():
    ...
    while True:
        if counter == 0:
            ...
            user_input = input(
                f"\nEXPENSE TRACKER\n"
                f"\nCurrent Balance: {currency}{balance} | This Month's Income: {currency}{month_pay} | This Month's Expenses: {currency}{month_expense}"
                f"\n------------------------------------\n"
                f"1. Add Pay To Current Balance:\n"
                f"2. Add Expenses: \n"
                f"3. View Monthly Report: \n"
                f"4. Other Options: \n"
                f"5. Exit: \n"
                )
