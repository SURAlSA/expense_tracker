...
def expense():
    ...
    if confirm == "yes":
        ...
        with open("expense_history.txt", "a") as history_file:
            for expense in expenses:
                expense_type, expense_amount = expense
                history_file.write(f"Date: {current_time}, Expense Type: {expense_type}, Expense Amount: {expense_amount}, Balance Before: {balance}, Balance After: {balance - expense_amount}\n")
